 ...
 */
const BorderBeamPanelBase = React.forwardRef<HTMLDivElement, BorderBeamPanelProps>(({
  children,
  beams = 2,
  colors,
  thickness = 2,
...
export const BorderBeamPanel = React.forwardRef<HTMLDivElement, BorderBeamPanelProps>((props, ref) => {
  return (
    <>
      <style dangerouslySetInnerHTML={{ __html: MOTIQ_TOKENS }} />
      <BorderBeamPanelBase ref={ref} {...props} />
    </>
  );
});
