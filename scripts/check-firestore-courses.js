 ...
 * Usage: node scripts/check-firestore-courses.js
 */
...
async function main() {
  ...
  if (args.length === 0) {
    ...
    console.log('Usage:');
    console.log('  node scripts/check-firestore-courses.js              # List all courses');
    console.log('  node scripts/check-firestore-courses.js find <title>  # Find course by title');
    process.exit(1);
  }
